class RoutePaths {
  ...
  static const String cProfile = '/citizen/profile';
  ...
  static String citizenComplaintDetails(int complaintId) {
    return '/citizen/complaints/$complaintId';
  }

  static String citizenUpdateComplaint(int complaintId) {
    return '/citizen/update/$complaintId';
  }

  static String citizenTrackComplaint(String referenceCode) {
    return '/citizen/track/$referenceCode';
  }
