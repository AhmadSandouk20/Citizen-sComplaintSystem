...
import '../../features/admin/presentation/bloc/mobile/agency/agency_complaints_cubit/admin_agency_complaints_cubit.dart';
import '../../features/admin/presentation/bloc/mobile/agency/agency_cubit/admin_agency_cubit.dart';
import '../../features/admin/presentation/bloc/mobile/staff/staff_management_cubit.dart';
...
void setupDependencies() {
  ...
  getIt.registerLazySingleton<DioClient>(
    () => DioClient(
      tokenProvider: () => "2|TiTzckYDMoGxCtDIxzwNTnKMk7m4Bby0wzYMXyQ2280362ba",
      onUnauthorized: () {
