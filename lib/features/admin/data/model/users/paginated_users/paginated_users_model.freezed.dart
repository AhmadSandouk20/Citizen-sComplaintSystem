...
class _PaginatedUsers implements PaginatedUsers {
  const _PaginatedUsers({@JsonKey(name: 'current_page') required this.currentPage, required final  List<UserModel> data, @JsonKey(name: 'first_page_url') this.firstPageUrl, this.from, @JsonKey(name: 'last_page') required this.lastPage, @JsonKey(name: 'last_page_url') this.lastPageUrl, final  List<PaginatedUsersLinkModel>? links, @JsonKey(name: 'next_page_url') this.nextPageUrl, this.path, @JsonKey(name: 'per_page') required this.perPage, @JsonKey(name: 'prev_page_url') this.prevPageUrl, this.to, required this.total}): _data = data,_links = links;
