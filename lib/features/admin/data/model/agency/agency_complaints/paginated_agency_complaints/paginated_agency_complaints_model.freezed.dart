...
class _PaginatedAgencyComplaints implements PaginatedAgencyComplaints {
  const _PaginatedAgencyComplaints({@JsonKey(name: 'current_page') required this.currentPage, required final  List<AgencyComplaintModel> data, @JsonKey(name: 'last_page') required this.lastPage, @JsonKey(name: 'per_page') required this.perPage, required this.total}): _data = data;
