...
class _PaginatedAgencies implements PaginatedAgencies {
  const _PaginatedAgencies({@JsonKey(name: "data") required final  List<AgencyModel> agencies, @JsonKey(name: 'current_page') required this.currentPage, @JsonKey(name: 'last_page') required this.lastPage, @JsonKey(name: 'per_page') required this.perPage, required this.total}): _agencies = agencies;
