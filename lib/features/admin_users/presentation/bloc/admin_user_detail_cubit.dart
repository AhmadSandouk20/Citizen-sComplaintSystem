...
class AdminUserDetailCubit extends Cubit<AdminUserDetailState> {
  AdminUserDetailCubit(this._repository)
  ...
  Future<void> save() async {
    ...
    try {
      ...
      emit(current.copyWith(isSaving: false, actionError: _message(error)));
    }
  }
  ...
  Future<void> delete() async {
    ...
    try {
      ...
      emit(AdminUserDetailDeleted(current.user.id));
    } catch (error) {
      emit(current.copyWith(isDeleting: false, actionError: _message(error)));
    }
  }
